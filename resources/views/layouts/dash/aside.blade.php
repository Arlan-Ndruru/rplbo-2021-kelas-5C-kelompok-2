<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard "
            target="_blank">
            <img src="{{URL::asset('home/assets/img/SP3.gif')}}" class="img-thumbnail navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold text-white">Sistem Pelayanan <br>Surat Menyurat Satu Pintu</span>
        </a>
    </div>
