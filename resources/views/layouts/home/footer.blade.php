            ...
            <div class="col-md-3 mb-4 ms-auto">
                <div>
                    <a href="https://www.creative-tim.com/product/material-kit">
                        <img src="{{URL::asset('home/assets/img/SP2.gif')}}" class="mb-3 footer-logo"
                            alt="main_logo">
                    </a>
                    <h6 class="font-weight-bolder mb-4">Sistem Informasi Pelayanan Surat Menyurat</h6>
                </div>
                <div>
            ...
            <div class="col-12">
                <div class="text-center">
                    <p class="text-dark my-4 text-sm font-weight-normal">
                        ...
                        </script> SP <a href="/" target="_blank">11950111676</a>.
                    </p>
                </div>
            </div>
        </div>
