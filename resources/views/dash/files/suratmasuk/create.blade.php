    ...
    <div class="row">
        <div class="col-xl-5">
            <div class="card my-4">
                ...
                <div class="card-body">
                    <form role="form" method="POST" action="{{route('dashSmasukStore')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group w-100 input-group-dynamic mt-3 mb-4 is-filled">
                            ...
                            <span></span>
                            <select name="asal_surat" class="form-control opacity-8" id="nameid" autofocus>
                        ...
                        <div class="input-group w-100 input-group-dynamic mb-3 is-filled">
                            <label class="form-label">Pilih Pengaju Surat</label>
                            <span></span>
                        ...
                        <div class="input-group w-100 input-group-outline mb-3 is-filled">
                            ...
                            <input type="file" name="doc" class="form-control @error('doc') is-invalid @enderror" id="file-open" onchange="previewFile()" accept=".pdf"><br>
                            @error('doc')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
