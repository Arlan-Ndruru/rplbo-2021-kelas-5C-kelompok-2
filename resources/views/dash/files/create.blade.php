    ...
    <div class="row">
        <div class="col-xl-5">
            <div class="card my-4">
                ...
                <div class="card-body">
                    <form role="form" method="POST" action="{{route('userberkasStore')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group w-100 input-group-dynamic mt-2 mb-4 is-filled">
                        ...
                        <div class="input-group input-group-dynamic my-3">
                            <label class="form-label" for="basic-url">Nomor Surat</label>
                            <span class="input-group-text" id="basic-addon3"><i>*kosongkan jika tidak ada</i></span>
                            <input type="text" name="no_surat" class="form-control @error('no_surat') is-invalid @enderror"
                                value="{{old('no_surat')}}" id="basic-url" aria-describedby="basic-addon3" onfocus="focused(this)"
                        ...
                        <div class="input-group w-100 input-group-outline mb-3 is-filled">
                            <label class="form-label">Keterangan : Tambahkan informasi tambahan tentang berkas</label>
    ...
    <script>
        ...
        const slug = document.querySelector('#slug');
                ...
                name.addEventListener('change', function(){
                    fetch('/dashboard/uploudberkas/checkSlug?name=' + name.value)
