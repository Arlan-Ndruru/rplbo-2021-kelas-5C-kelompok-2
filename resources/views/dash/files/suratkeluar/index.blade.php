...
<div class="container-fluid  scrollspy-example" data-bs-spy="scroll" data-bs-target="#navbar-example2"
    ...
    <div class="justify-content-center d-flex">
        <div class="col-xl-5">
            <a href="{{route('dashSkeluarAdd')}}" class="btn btn-outline-dark btn-lg text-capitalize"><i
                    class="bi bi-person-plus"></i> Ajukan Surat</a>
        </div>
        <div class="form col-md-5">
            <form action="/dashboard/suratkeluar/">
                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize d-inline ps-3" id="lookinstance"><i
                                class="bi bi-person"></i> Surat Keluar</h6>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table  align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <p class="text-secondary text-sm ms-3 mb-0 font-weight-bold">
                                            {{$loop->iteration}}</p>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <span class="text-secondary text-sm mb-0 font-weight-bold">
                                            ...
                                            @elseif(Auth::user()->hasRole(['kepalaTU']))
                                                ...
                                                @else
                                                    <span class="badge bg-warning">Surat Diajukan Admin & belum dikelola</span>
                                                @endif
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{route('dashSkeluarDelete', $file->slug)}}" method="POST"
                                            class="d-inline">
                                            @method('delete')
                                            @csrf
                                            <button
